namespace Siwait.Phone.Client.Core.Services.HttpMessageHandlers;
...
///
/// 1. <see cref="RequestHeadersDelegationHandler" />
/// 2. <see cref="AuthDelegatingHandler" />
/// 3. <see cref="RetryDelegatingHandler" />
/// 4. <see cref="ExceptionDelegatingHandler" />
///
