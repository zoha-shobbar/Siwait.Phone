...
public partial class App
{
    ...
    protected async override void OnStart()
    {
        ...
        webViewVersion.Major < 83)
            {
                await App.Current!.Windows.First().Page!.DisplayAlert("Siwait.Phone", localizer[nameof(AppStrings.UpdateWebViewThroughGooglePlay)], localizer[nameof(AppStrings.Ok)]);
